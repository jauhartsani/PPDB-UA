                                    ...
                                    <div class="card tryal-gradient">
                                        <div class="card-body tryal row">
                                            ...
                                            <div class="col-xl-5 col-sm-6">
                                                <img src="{{ asset('ppdbua/images/chart.png') }}" alt=""
                                                    class="sd-shape">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xl-6 col-sm-6">
                                                    <div class="items">
                                                        <h4 class="fs-20 font-w700 mb-4">Data Progress <br> Penerimaan Santri
                                                            Baru</h4>
        ...
        @elseif(auth()->user()->role == 'Calon Mahasiswa')
            ...
            <div class="row page-titles" style="border-radius: 0%">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">PPDB UA</a></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-xl-7">
                            ...
                            <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ asset('ppdbua/images/banner (1).png') }}"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('ppdbua/images/banner (2).png') }}"
                                            alt="Second slide">
                                    </div>
                                </div>
            ...
            <div class="row">
                    ...
                    <div class="card" style="border-radius: 0%;">
                            <div class="new-arrival-product">
                                <div class="new-arrivals-img-contnent">
                                    <img class="img-fluid" src="{{ asset('ppdbua/images/logo_sdi.png') }}" alt="">
                                    <div class="carousel-caption d-none d-md-block">
                                        <a href="ecom-product-detail.html"><h4 style="color: whitesmoke">SEKOLAH DASAR ISLAM PLUS</h4></a>
                                        <p>ULUL ALBAB</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
                    <div class="card" style="border-radius: 0%">
                            <div class="new-arrival-product">
                                <div class="new-arrivals-img-contnent">
                                    <img class="img-fluid" src="{{ asset('ppdbua/images/logo_smpi.png') }}"
                                        alt="">
                                        <div class="carousel-caption d-none d-md-block">
                                            <a href="ecom-product-detail.html"><h4 style="color: whitesmoke">SEKOLAH MENENGAH PERTAMA ISLAM</h4></a>
                                            <p>ULUL ALBAB</p>
                                        </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
                    <div class="card" style="border-radius: 0%">
                            <div class="new-arrival-product">
                                <div class="new-arrivals-img-contnent">
                                    <img class="img-fluid" src="{{ asset('ppdbua/images/logo_smki.png') }}" alt="">
                                    <div class="carousel-caption d-none d-md-block">
                                        <a href="ecom-product-detail.html"><h4 style="color: whitesmoke">SEKOLAH MENENGAH KEJURUAN ISLAM</h4></a>
                                        <p>ULUL ALBAB</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6" style="padding: 0px">
                    <div class="card" style="border-radius: 0%">
                            <div class="new-arrival-product">
                                <div class="new-arrivals-img-contnent">
                                    <img class="img-fluid" src="{{ asset('ppdbua/images/logo_mabl.png') }}" alt="">
                                    <div class="carousel-caption d-none d-md-block" >
                                        <a href="ecom-product-detail.html"><h4  style="color: whitesmoke">MADRASH ALIYAH BILINGUAL</h4></a>
                                        <p>ULUL ALBAB</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade show active" id="first">
                                                    <img class="img-fluid" src="{{ asset('ppdbua/images/brosur1.jpeg') }}" alt="">
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="second">
                                                    <img class="img-fluid" src="{{ asset('ppdbua/images/brosur2.jpeg') }}" alt="">
                                                </div>
                                            </div>
                                                ...
                                                <ul class="nav slide-item-list mt-3" role="tablist">
                                                    <li role="presentation" class="show">
                                                        <a href="#first" role="tab" data-bs-toggle="tab">
                                                            <img class="img-fluid" src="{{ asset('ppdbua/images/brosur1.jpeg') }}" alt="" width="50">
                                                        </a>
                                                    </li>
                                                    <li role="presentation">
                                                        <a href="#second" role="tab" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('ppdbua/images/brosur2.jp3g') }}" alt="" width="50"></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <p class="text-content">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                                        ...
                                                        <div class="tab-content">
                                                            <div id="jpk" class="tab-pane fade active show">
                                                                ...
                                                                <div class="profile-about-me">
                                                                    <div class="pt-4 border-bottom-1 pb-3">
                                                                        <h4 class="text-primary">Sosial Media Saya</h4>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-2">
                                                                    <div class="col-sm-3 col-5">
